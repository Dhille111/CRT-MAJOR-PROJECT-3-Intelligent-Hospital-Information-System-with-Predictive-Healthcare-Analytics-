    ...
    datasets: [
      {
        ...
        backgroundColor: ["#269683", "#4382dc", "#22c55e"],
        borderWidth: 0,
      },
    ],
  };
    ...
    datasets: [
      {
        ...
        backgroundColor: "rgba(38, 150, 131, 0.12)",
        borderColor: "#269683",
        borderRadius: 14,
      },
    ],
    ...
    <div className="space-y-6">
      <section className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
        <Card className="relative overflow-hidden">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(38,150,131,0.10),_transparent_28%),radial-gradient(circle_at_bottom_right,_rgba(67,130,220,0.08),_transparent_30%)]" />
